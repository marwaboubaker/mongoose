...
const arrayofpeople = [
  { name: "John", age: 23, favouriteFood: ["donuts", "steack"] },
  { name: "Zlatan", age: 40, favouriteFood: ["salad", "chicken"] },
];
...
router.get("/getpersonbyfood/:food",async (req, res) => {
   const {food} = req.params
   console.log(food)

   const p = await Person.findById(food)
    
   res.json({foods : p.favouriteFood})
